...
http://www.apiman.io[Apiman] is an open-source API management offering, that makes it easy to control, distribute and monitor your APIs. It consists of two main components:
...
REST API:: All of the functionality provided by apiman in its Management UI is directly supported in a REST API. 

 ...
 */
function loadIframe(dynamicURL) { if (dynamicURL == '') {window.location.href = '#';} else  if (dynamicURL == '') {window.location.href = '#';} else  if (dynamicURL == 'devplatform/1.1devplatform.ALS-developer-trial-quick-start.html') {window.location.href = '#devplatform/1.2/1.2devplatform.ALS-developer-trial-quick-start.html';} else 
